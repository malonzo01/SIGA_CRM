<!-- Modal -->
<div class="modal fade" id="ModalOfficialCrear" tabindex="-1" aria-labelledby="ModalOfficialCrear" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="ModalOfficialCrear">Nuevo Funcionario <span class="icon-nuevo"></span></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <span id="form_result"></span>
        <div class="border border-primary rounded" style="padding:20px;">
        <form id="form_officials_post" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row">
          ...
          <div class="row">
              ...
              <div class=" col-md-6 col-sm-12 form-group mt-2">
               ...
               <div class="col-md-6 col-sm-12 form-group mt-2">
                  <label>Cuerpo:</label>
                  <select name="body_id" id="body_id" class="form-control" required>
                      <option value="">Seleccione</option>
                      @foreach($bodies as $b)
              ...
              <div class=" col-md-6 col-sm-12 form-group mt-2" id="body_div">
              ...
              <div class="col-md-6 col-sm-12 form-group mt-2">
                  ...
                  <input type="text" name="second_surname" id="second_surname" class="form-control" required>
              </div>
