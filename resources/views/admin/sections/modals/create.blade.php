<!-- Modal -->
<div class="modal fade" id="ModalSeccionCrear" tabindex="-1" aria-labelledby="ModalSeccionCrear" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title" id="ModalSeccionCrear">Nueva Sección <span class="icon-nuevo"></span></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <span id="form_result"></span>
        <div class="border border-primary rounded" style="padding:20px;">
        <form id="form_sections_post" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row">
