...
<div class="div-master" style="width:100%; margin-bottom:20px;padding:0px 0px 0px 80px;">
	<table style="border-spacing: 0;margin-top:-140px;text-align:center">
		<tr>
			<td width="130">
				<p>
					<img src="{{public_path('img/placas/state-seal-ny.png')}}" style="margin-right:-100px" width="100" />
				</p>
			</td>
			<td width="700">
				<h4 style="font-size:8em;font-family: 'Times New Roman', Times, serif;letter-spacing: 0.01em;margin-left:-270px">New York</h4>
			</td>
		</tr>
	</table>
	...
	<table style="border-spacing: 0;">
		<tr>
			<td width="830">
				<h4 style="font-size:15em;font-family: 'Roboto', sans-serif;letter-spacing: 0em;margin-top: -80px;transform: scale(1, 1.3);">{{ $tag_number }}</h4>
			</td>
		</tr>
	</table>
	<table style="border-spacing: 0;margin-top: -410px">
		<tr>
			<td width="180">
				...
				<h4 style="font-size:20px;font-weight:400;margin-top:-26px;margin-left:-24px;white-space:pre">{{ $request->year }} {{ $request->make }} {{ $request->major_color }}</h4>
			</td>
			<td width="360">
				<center>
