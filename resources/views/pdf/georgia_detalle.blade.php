...
<div class="div-master" style="width:100%;padding:0px 0px 0px 100px;text-align:center;">
    ...
    <table style="text-align:center;margin-top: 200px;margin-bottom:0px;">
        <tr style="padding: 2px 0px 2px 0px;">
            <th width="700" >
                <h4
                    style="font-size:1.5em;font-family:Arial, Helvetica, sans-serif;text-align:center;font-weight:400;margin-top:0px;">
    ...
    <table style="margin-top: 20px;margin-bottom:-0px;">
        <tr style="padding: 2px 0px 2px 0px;">
            <th width="325">
                <h4 style="font-size:1em;font-family:Arial, Helvetica, sans-serif;text-align:center;font-weight:700;margin-top:0px;margin-bottom:0px;border-bottom: 1px solid black;">
