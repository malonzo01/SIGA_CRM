...
<body style="background-color: #f6c50d; padding:0px; ">
    <div class="div-master" style="height:60%; width:100%; ">
        <table style="margin-left:100px; margin-top:30px; margin-bottom:5px;">
            ...
            <tr>
                <td><span style="text-align: left;   font-size:1.2em; font-family: 'Anton', sans-serif;font-weight:bold;color:#000;">VIN</span></td>
                <td><span style="margin-left:18px;   text-align: left; font-size:1.2em; font-family: 'Roboto', sans-serif;font-weight:bold;color:#000;">YEAR</span></td>
                <td><span style="margin-left:-168px; text-align: left; font-size:1.2em; font-family: 'Roboto', sans-serif;font-weight:bold;color:#000;">MAKE</span></td>
                <td><span style="margin-left:-208px; text-align: left; font-size:1.2em; font-family: 'Roboto', sans-serif;font-weight:bold;color:#000;">MODEL</span></td>
                <td><span style="margin-left:-100px; text-align: left; font-size:1.2em; font-family: 'Roboto', sans-serif;font-weight:bold;color:#000;">WEIGHT</span></td>
            </tr>
            <tr>
                <td><span style=" font-family:Roboto,Arial, Helvetica, sans-serif;font-weight:bold;color:#000;">{{ $request->vin }}</span></td>
                <td><span style=" font-family:Roboto,Arial, Helvetica, sans-serif;font-weight:bold;color:#000;margin-left:18px;">{{ $request->year }}</span></td>
                <td><span style=" font-family:Roboto,Arial, Helvetica, sans-serif;font-weight:bold;color:#000;margin-left:-168px;">{{ $request->make }}</span></td>
                <td><span style=" font-family:Roboto,Arial, Helvetica, sans-serif;font-weight:bold;color:#000;margin-left:-208px;">{{ $request->model }}</span></td>
                <td ><span style=" font-family:Roboto,Arial, Helvetica, sans-serif;font-weight:bold;color:#000;margin-left:-100px;"></span></td>
            </tr>
            <tr >
                <td colspan="3" ><span style="font-size:150px; font-weight: bold; font-family: 'Anton', sans-serif;letter-spacing: 0em;color:#000; text-align:left">{{ $tag_number }}</span></td>
            </tr>
            <tr>
                <td><span style="font-family: 'Roboto', sans-serif;letter-spacing: 0em; font-weight:700; font-size:55px; color:#000;">Exp:</span></td>
                <td><span style="margin-left:-140px;font-family: 'Roboto', sans-serif;letter-spacing: 0em; font-weight:700; font-size:45px; color:#000;">{{ $lateDay_Qr }}</span></td>
            -</tr>
            <tr>
            ...
            <tr>
                <td><span style=" Helvetica, sans-serif;font-weight:bold;color:#000;">{{ $request->seller }}</span></td>
                <td><span style=" Helvetica, sans-serif;font-weight:bold;color:#000;">{{ $request->deler_number }}</span></td>
                <td><span style=" font-family:Roboto,Arial, Helvetica, sans-serif;font-weight:bold;color:#000;margin-left:-200px;">{{ $initDay_Qr }}</span></td>
            </tr>
        </table>
    </div>
    <div class="div-master" style="width:100%;margin-top:-65px;padding:4px; ">
        <table style=" border_top: 3px dashed #000;margin-top:px;margin-bottom:0px;">
            <tr>
                <td style="width:50">
                    <span>
                        <img src="data:image/png;base64,{{ base64_encode($dirImage)}}" style=" margin-top:80px; margin-left: 10px; width: 55px; height:55px"/>
                    </span>
                </td>
                <td style="width:150.8; border-left: 0px dashed #000;">
                    ...
                    <table style="margin-left:5%; margin-top:0px">
                        <tr>
                ...
                <td style="width:150.8; border-left: 3px dashed #000; ">
                    ...
                    <table style="margin-left:8%;margin-top:0px;">
                        <tr>
                            <td>
                                <center>
                                    <h4 style="margin-left:15px;  font-size:1.2em; font-family: 'Roboto', sans-serif;font-weight:700;">ILLINOIS TEMPORARY PERMIT</h4>
